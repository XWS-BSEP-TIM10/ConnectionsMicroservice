package com.connections.security.config;

import com.connections.security.auth.RestAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/api/v1/users*").permitAll()        // /auth/**
