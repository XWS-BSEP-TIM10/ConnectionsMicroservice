...
public interface ConnectionRepository extends Neo4jRepository<Connection, Long> {
    ...
    @Query("MATCH (u1:User {username: $0})-[r:CONNECTION]->(u2:User {username: $1}) SET r.connectionStatus = $2 RETURN r")
    Connection updateConnectionStatus(String connectingUser, String connectedUser, String connectionStatus);
}
